...
m=m.replace("and revision-specific reporting scripts are supplied in the accompanying reproducibility releases. The project repository is https://github.com/harrisondfletcher/accuracy-illusion. The Open Practices Statement identifies the distinction between the project repository and the versioned materials accompanying this revision.",
 "and revision-specific reporting scripts are supplied in the accompanying reproducibility releases. The exact Version 4.1 package is archived at [INSERT OSF/ZENODO DOI OF THE PUBLISHED V4.1 RELEASE]. The project repository is https://github.com/harrisondfletcher/accuracy-illusion. The Open Practices Statement identifies the distinction between the project repository and the versioned archived release.")
m=m.replace("The project repository is https://github.com/harrisondfletcher/accuracy-illusion; the versioned accompanying releases, rather than an unversioned project page, identify the numerical sources of this revision.",
 "The exact Version 4.1 package supporting this revision is archived at [INSERT OSF/ZENODO DOI OF THE PUBLISHED V4.1 RELEASE]; that versioned archive, rather than the unversioned project page (https://github.com/harrisondfletcher/accuracy-illusion), identifies the numerical sources of this revision.")
